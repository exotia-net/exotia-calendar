...
public class ConfigurationGui extends OkaeriConfig {
    ...
    private HashMap<String, GuiButton> setupButtons() {
        ...
        buttons.put("wygasly", GuiButton.builder()
            ...
            .type("oraxen")
            .displayName("Nagroda za <gradient:#4fa943:#9ec52f><bold>dzień %value_1%!</bold></gradient>")
        ...
        buttons.put("bonusowy_otwarty", GuiButton.builder()
            ...
            .type("oraxen")
            .displayName("Nagroda <gradient:#7776ff:#ae2cf1><bold>bonusowa!</bold></gradient>")
            .lore(Arrays.asList("%value_1%"))
            .build()
        );
        ...
        buttons.put("streak_wygasly", GuiButton.builder()
            ...
            .lore(Arrays.asList("Loguj się codziennie", "na serwer, aby uzyskać", "<gradient:#7776ff:#ae2cf1><bold>bonusową nagrodę!</bold></gradient>"))
            .build()
        );
